...
TEST_F(ShapedRecipeTest, Create_2x2Recipe)
{
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "planks_to_crafting_table"), 2, 2, std::vector<Ingredient>(), ItemStack());
...
{
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "large_recipe"), 3, 3, std::vector<Ingredient>(), ItemStack());
...
{
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "small_recipe"), 2, 2, std::vector<Ingredient>(), ItemStack());
...
{
    auto recipe = std::make_unique<ShapedRecipe>(ResourceLocation("test", "empty_recipe"),
        1,
        1,
...
TEST_F(ShapedRecipeTest, Matches_EmptyRecipe_NonEmptyInventory_ReturnsFalse)
{
    ...
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "empty_recipe"), 0, 0, std::vector<Ingredient>(), ItemStack());
...
TEST_F(ShapedRecipeTest, Matches_SingleItem_CorrectPosition)
{
    ...
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "single_stone"), 1, 1, std::vector<Ingredient>{stoneIng}, ItemStack(*stone, 2));
...
TEST_F(ShapedRecipeTest, Matches_2x2Recipe_CorrectPattern)
{
    ...
    auto recipe = std::make_unique<ShapedRecipe>(ResourceLocation("test", "crafting_table"),
        2,
        2,
...
TEST_F(ShapedRecipeTest, Matches_MirroredPattern_ReturnsTrue)
{
    ...
    Ingredient planksIng = Ingredient::fromItem(*planks);
    Ingredient stoneIng = Ingredient::fromItem(*stone);
    auto recipe = std::make_unique<ShapedRecipe>(ResourceLocation("test", "asymmetric"),
        2,
        1,
...
TEST_F(ShapedRecipeTest, Assemble_ReturnsCorrectResult)
{
    ...
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "stone_x4"), 1, 1, std::vector<Ingredient>{stoneIng}, result);
...
{
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "recipe"), 1, 1, std::vector<Ingredient>(), ItemStack(), "test_group");
...
{
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "recipe"), 1, 1, std::vector<Ingredient>(), ItemStack());
...
{
    auto recipe = std::make_unique<ShapedRecipe>(
        ResourceLocation("test", "shaped_recipe"), 2, 2, std::vector<Ingredient>(), ItemStack());
...
TEST_F(ShapedRecipeTest, GetRecipeFromManager_CorrectType)
{
    ...
    const CraftingRecipe* found = RecipeManager::instance().getRecipe(ResourceLocation("test", "shaped_recipe"));
