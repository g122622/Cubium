...
class SetStewEffectTestWorld : public IWorld {
public:
    ...
    [[nodiscard]] math::Random& getRandom() override {
        throw std::runtime_error("SetStewEffectTestWorld::getRandom not implemented");
    }
    ...
    [[nodiscard]] world::border::WorldBorder& worldBorder() override {
        throw std::runtime_error("SetStewEffectTestWorld::worldBorder not implemented");
    }
