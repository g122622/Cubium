 ...
 * 提供最小化测试环境用于豹猫实体功能测试
 */
class OcelotTestWorld final : public IWorld {
public:
    ...
    [[nodiscard]] math::Random& getRandom() override {
        throw std::runtime_error("OcelotTestWorld::getRandom not implemented");
    }
    ...
    [[nodiscard]] world::border::WorldBorder& worldBorder() override {
        throw std::runtime_error("OcelotTestWorld::worldBorder not implemented");
    }
