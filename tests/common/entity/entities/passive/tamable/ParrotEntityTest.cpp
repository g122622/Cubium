 ...
 * 提供最小化测试环境用于鹦鹉实体功能测试
 */
class ParrotTestWorld final : public IWorld {
public:
    ...
    [[nodiscard]] math::Random& getRandom() override {
        throw std::runtime_error("ParrotTestWorld::getRandom not implemented");
    }
    ...
    [[nodiscard]] world::border::WorldBorder& worldBorder() override {
        throw std::runtime_error("ParrotTestWorld::worldBorder not implemented");
    }
