 ...
 * @brief 测试用模拟世界
 */
class FoxTestWorld final : public IWorld {
public:
    ...
    [[nodiscard]] math::Random& getRandom() override {
        throw std::runtime_error("FoxTestWorld::getRandom not implemented");
    }
    ...
    [[nodiscard]] world::border::WorldBorder& worldBorder() override {
        throw std::runtime_error("FoxTestWorld::worldBorder not implemented");
    }
