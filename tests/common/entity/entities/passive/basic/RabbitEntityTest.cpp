 ...
 * @brief 测试用模拟世界
 */
class RabbitTestWorld final : public IWorld {
public:
    ...
    [[nodiscard]] math::Random& getRandom() override {
        throw std::runtime_error("RabbitTestWorld::getRandom not implemented");
    }
    ...
    [[nodiscard]] world::border::WorldBorder& worldBorder() override {
        throw std::runtime_error("RabbitTestWorld::worldBorder not implemented");
    }
