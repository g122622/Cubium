 ...
 */
class ZombieVillagerTestWorld final : public IWorld {
public:
    ...
    [[nodiscard]] math::Random& getRandom() override {
        throw std::runtime_error("ZombieVillagerTestWorld::getRandom not implemented");
    }
    ...
    [[nodiscard]] world::border::WorldBorder& worldBorder() override {
        throw std::runtime_error("ZombieVillagerTestWorld::worldBorder not implemented");
    }
