...
void TargetInfoWidget::paint(kagero::widget::PaintContext& ctx) {
    ...
    const i32 panelWidth = static_cast<i32>(contentWidth) + PANEL_LEFT_PADDING + PANEL_RIGHT_PADDING + PANEL_ACCENT_WIDTH;
    ...
    ctx.drawFilledRect(kagero::Rect(panelX, panelY + 1, PANEL_ACCENT_WIDTH, panelHeight - 2), m_targetInfo.accentColor());
