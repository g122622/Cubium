...
#include "server/test/base/data/TestParameters.hpp"
#include "server/test/base/error/GameTestError.hpp"  // GameTestError/_failBatchEnvironment 参数
#include "server/test/base/error/GameTestResult.hpp" // GameTestResult（_applyBatchEnvironment* 返回值）
#include "server/test/framework/batch/GameTestBatch.hpp"
#include "server/test/framework/batch/GameTestBatchListener.hpp"
#include "server/test/framework/listener/IGameTestListener.hpp" // setInstanceListener 持有
