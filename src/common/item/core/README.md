...
- `entity` - 持有实体（通常是玩家）
- `itemSlot` - 物品栏槽位索引
- `isSelected` - 是否为当前选中的物品

**子类实现**：
- `ElytraItem` - 鞘翅滑翔时消耗耐久度

### Item::onArmorTick()

护甲物品在护甲栏中每 tick 调用，用于实现护甲特殊效果。
