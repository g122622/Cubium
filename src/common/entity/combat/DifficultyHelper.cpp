...
f32 DifficultyHelper::getMobDamageAdjustment(i32 difficultyId) {
    switch (difficultyId) {
        case 0: return 0.0f;   // Peaceful
        case 1: return EASY_MOB_DAMAGE_ADJ;   // Easy: -2
        case 2: return NORMAL_MOB_DAMAGE_ADJ; // Normal: 0
        case 3: return HARD_MOB_DAMAGE_ADJ;   // Hard: +2
        default: return NORMAL_MOB_DAMAGE_ADJ;
    }
}
