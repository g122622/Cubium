...
inline JigsawOrientation fromFacingAndRotation(Direction facing, Direction rotation)
{
    ...
    if (facing == Direction::Down) {
        switch (rotation) {
            ...
            case Direction::North:
                return JigsawOrientation::DownNorth;
            case Direction::South:
                return JigsawOrientation::DownSouth;
            case Direction::West:
                return JigsawOrientation::DownWest;
            default:
                return JigsawOrientation::DownNorth;
        }
    }
    ...
    if (facing == Direction::Up) {
        switch (rotation) {
            case Direction::East:
                return JigsawOrientation::UpEast;
            case Direction::North:
                return JigsawOrientation::UpNorth;
            case Direction::South:
                return JigsawOrientation::UpSouth;
            case Direction::West:
                return JigsawOrientation::UpWest;
            default:
                return JigsawOrientation::UpNorth;
        }
    }
    ...
    switch (facing) {
        ...
        case Direction::East:
            return JigsawOrientation::EastUp;
        case Direction::North:
            return JigsawOrientation::NorthUp;
        case Direction::South:
            return JigsawOrientation::SouthUp;
        default:
            return JigsawOrientation::NorthUp;
    }
}
