    ...
    const BlockState* foliageBlock)
{
    ...
    for (i32 y = offset; y >= -foliageHeight; --y) {
        // 放置当前层的树叶
        placeFoliageLayer(world, random, foliagePos, currentRadius, y, foliageBlocks, foliageBlock, foliagePos.trunkTop);
...
void SpruceFoliagePlacer::placeFoliageLayer(
    WorldGenRegion& world,
    math::Random& random,
    const FoliagePosition& foliagePos,
    i32 radius,
    ...
    const BlockState* foliageBlock)
{
    ...
    placeFoliageLayer(world, random, foliagePos, radius + foliagePos.radiusBonus, -1 - foliageHeight, foliageBlocks, foliageBlock, trunkTop);
    ...
    placeFoliageLayer(world, random, foliagePos, radius + foliagePos.radiusBonus - 1, 0, foliageBlocks, foliageBlock, trunkTop);
}

void AcaciaFoliagePlacer::placeFoliageLayer(
    WorldGenRegion& world,
    math::Random& random,
    const FoliagePosition& foliagePos,
    i32 radius,
...
void DarkOakFoliagePlacer::placeFoliageLayer(
    WorldGenRegion& world,
    math::Random& random,
    const FoliagePosition& foliagePos,
    i32 radius,
...
bool DarkOakFoliagePlacer::shouldSkipBase(
    math::Random& random,
    i32 dx, i32 dy, i32 dz,
    i32 radius,
    bool trunkTop) const
