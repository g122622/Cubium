...
struct JigsawConfig {
    ...
    JigsawConfig(const ResourceLocation& pool, i32 s) : startPool(pool), size(s) {}
};
...
public:
    ...
    bool canGenerate(IWorld& world, IChunkGenerator& generator, math::Random& rng,
                    i32 chunkX, i32 chunkZ) override;

    std::unique_ptr<StructureStart> generate(IWorldWriter& world, IChunkGenerator& generator,
