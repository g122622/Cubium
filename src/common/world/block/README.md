...
- **原木和树叶**：OAK_LOG, SPRUCE_LOG, BIRCH_LOG, JUNGLE_LOG, ACACIA_LOG, DARK_OAK_LOG 及对应树叶
...
- **海晶系列**：PRISMARINE, PRISMARINE_BRICKS, DARK_PRISMARINE, SEA_LANTERN
...
- **海洋方块扩展**：SEA_PICKLE, KELP, KELP_PLANT, SEAGRASS, TALL_SEAGRASS
- **珊瑚方块扩展**：TUBE/BRAIN/BUBBLE/FIRE/HORN 的 coral_block、coral_fan、coral_wall_fan
