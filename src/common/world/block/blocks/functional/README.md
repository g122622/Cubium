...
- [x] ComposterBlock: 完整堆肥概率表（~66种物品，对齐MC 1.16.5，2026-05-28 完成）、骨粉产出、玩家交互
...
**CompostableItems 注册表** (2026-05-28 完成):
```cpp
// 堆肥概率表 (共 ~66 种物品，完整对齐 MC 1.16.5)
30%: 树叶(6种)、树苗(6种)、种子(4种)、海草类(3种)、草、甜浆果
50%: 干海带块、高草、仙人掌、甘蔗、藤蔓、西瓜片、下界藤蔓(2种)、下界苗
